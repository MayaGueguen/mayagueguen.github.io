...
- *5 novembre 2019* : journée utilisateurs CIMENT (Gricad)  
Présentations disponibles ici : [gricad-user](https://userday2019.sciencesconf.org/resource/page/id/1)


<br/><br/>

Après cette journée organisée par [`Gricad`](https://gricad.univ-grenoble-alpes.fr/), voici un aperçu de quelques points d'intérêts pour le laboratoire :
...
Les sites web de [`Gricad`](https://gricad.univ-grenoble-alpes.fr/) font peau neuve !
...
Ca nécessite de demander la synchronisation entre ses ID de Perseus (ciment) et de Summer
